...
import test_patch_execution as task5b
import test_patch_planning as planning
from src.app.kalama.prioritizer.trivy_parser import parse_trivy_report
...
from src.app.kalama.state.models import ArtifactKind, PipelineStage, RunStatus, StageStatus
from src.app.kalama.target.models import TrivyArtifact
from src.app.kalama.verification.comparison import compare_remediation_targets
from src.app.kalama.verification.orchestrator import AfterScanOrchestrator
...
class AfterScanIntegrationTests(unittest.TestCase):
    ...
    def test_comparison_publication_failure_preserves_committed_trivy_after(self):
        with patch("src.app.kalama.verification.orchestrator.write_remediation_scan_result",
