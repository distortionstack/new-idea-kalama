...
import test_before_exploit as task4_helpers
from src.app.kalama.remediation.models import FixType, PatchStrategy, RemediationCandidate
from src.app.kalama.remediation.orchestrator import PatchPlanningOrchestrator
from src.app.kalama.remediation.planner import build_patch_plan
...
class PatchPlanningIntegrationTests(unittest.TestCase):
    ...
    def test_unresolved_plan_generates_form_and_form_failure_is_fatal(self):
        ...
        self.tearDown()
        self.setUp()
        with patch("src.app.kalama.remediation.orchestrator.write_patch_form_immutable",
