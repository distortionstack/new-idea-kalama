...
**ID: F1 — Severity: MEDIUM — File: `src/app/kalama/remediation/discovery/os_package.py` — Function: `select_same_branch_fixed`**
...
**ID: F2 — Severity: MEDIUM — File: `src/app/kalama/remediation/discovery/os_package.py` — Function: `_distro_label` / `_discover_one`**
...
**ID: F3 — Severity: LOW — File: `src/app/kalama/remediation/discovery/os_package.py` — Function: `build_availability_query`/`_query_argv`**
...
**ID: F4 — Severity: LOW — File: `src/app/kalama/remediation/discovery/service.py` — Function: `AutomaticRemediationProvider.write_discovery_artifact`**
...
**ID: F5 — Severity: LOW — File: `src/app/kalama/remediation/discovery/os_package.py` — Function: `_combine_availability`/`_combine_status`**
