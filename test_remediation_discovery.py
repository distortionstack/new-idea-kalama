...
from src.app.kalama.remediation.discovery import (
...
from src.app.kalama.remediation.discovery.os_package import (
    OsPackageProvider, build_availability_query, parse_availability, select_same_branch_fixed,
)
from src.app.kalama.remediation.discovery.models import AvailabilityStatus
from src.app.kalama.remediation.discovery.source_build import SourceBuildProvider
from src.app.kalama.remediation.models import RemediationCandidate
...
class OrchestratorDiscoveryIntegrationTests(unittest.TestCase):
    ...
    def test_orchestrator_persists_discovery_artifact_and_plan_when_available(self):
        ...
        from src.app.kalama.state.models import ArtifactKind, RunStatus, PipelineStage
