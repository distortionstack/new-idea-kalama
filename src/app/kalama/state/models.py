...
class RunState:
    ...
    remediation_basis: str = "exploit-confirmed"
    ...
    def with_remediation_basis(self, basis: str, timestamp: str) -> "RunState":
        return replace(self, remediation_basis=basis, updated_at=timestamp)
    ...
    def to_dict(self) -> dict[str, Any]:
        return {
            ...
            "remediation_basis": self.remediation_basis,
        }
