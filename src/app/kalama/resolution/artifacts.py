...
from resolver_config_models import ExploitValue
...
def _form_cve(item: ResolverCVEResult, guidance: Mapping[str, Any] | None = None) -> dict[str, Any]:
    ...
    projected = {
        ...
        "disposition": {"suggested": None, "confirmed": None,
                        "note": "set to USER_SKIPPED to decline this CVE without blocking others"},
