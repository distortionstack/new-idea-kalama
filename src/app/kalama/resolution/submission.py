...
def apply_human_confirmation(
    ...
    allowed = {"rank", "input_reasons", "disposition", "module", "target", "targeturi",
               "module_options", "payload", "payload_options", "preconditions", "pre_attack",
