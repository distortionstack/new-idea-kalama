...
from src.app.kalama.resolution.confirmation_orchestrator import AttackFormOrchestrator
from src.app.kalama.resolution.config_codec import exploit_config_from_dict
from src.app.kalama.resolution.orchestrator import ResolverOrchestrator, production_step4_processor
from src.app.kalama.state.models import ArtifactKind, RunStatus, StageStatus
from src.app.kalama.state.store import StateStore
import test_step4_orchestrator as step4_helpers
...
class AttackFormSubmissionTests(unittest.TestCase):
    ...
    def test_snapshot_or_config_write_failure_does_not_commit_confirmations(self):
        ...
        with patch("src.app.kalama.resolution.confirmation_orchestrator.write_submission_snapshot",
