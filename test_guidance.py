...
from src.app.kalama.guidance.evidence import build_evidence_pack
from src.app.kalama.guidance.models import PROPOSAL_SCHEMA, ProposalValidationState
from src.app.kalama.guidance.ollama import OllamaConfig, OllamaProvider
from src.app.kalama.guidance.service import GuidanceService
from src.app.kalama.guidance.validator import validate_proposal
...
import test_step4_orchestrator as helpers
...
class GuidanceTests(unittest.TestCase):
    ...
    def test_no_unresolved_fields_skips_provider(self):
        ...
        from resolver_config_models import ConfigReadiness, ConfigValidationResult
        from src.app.kalama.resolution.models import ResolverCVEResult, Step4Analysis
    ...
    def test_no_module_status_skips_provider(self):
        from dataclasses import replace
        from src.app.kalama.resolution.models import ResolverCVEStatus, Step4Analysis
        calls = []
        class Provider:
            name, config = "fake", type("C", (), {"model": "fake"})()
            def propose(self, *_): calls.append(1)
